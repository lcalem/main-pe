"""
FROM HERE: https://github.com/keras-team/keras-contrib/blob/master/keras_contrib/applications/resnet.py
...
def ResNet18(input_shape, classes=10, top='classification'):
    """ResNet with 18 layers and v2 residual units
    """
    return ResNet(input_shape, classes, basic_block, repetitions=[2, 2, 2, 2], top=top)


def ResNet34(input_shape, classes=10, top='classification'):
    """ResNet with 34 layers and v2 residual units
    """
    return ResNet(input_shape, classes, basic_block, repetitions=[3, 4, 6, 3], top=top)
