...
def channel_softmax_2d():
    ...
    def _channel_softmax_2d(x):
        ...
        if ndim == 4:
            ...
            raise ValueError('This function is specific for 4D tensors. Here, ndim=' + str(ndim))
...
def channel_softmax_1d():
    ...
    def _channel_softmax_1d(x):
        ...
        if ndim == 3:
            ...
            raise ValueError('This function is specific for 3D tensors. Here, ndim=' + str(ndim))
