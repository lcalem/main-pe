...
def launch_training(dataset_path, model_folder, n_epochs, batch_size, pose_blocks):
    ...
    eval_callback = callbacks.H36MEvalCallback(pose_blocks, x_val, pw_val, afmat_val, puvd_val[:,0,2], scam_val, pose_only=True, logdir=model_folder)
    ...
    # model.train(data_tr_h36m, steps_per_epoch=10, model_folder=model_folder, n_epochs=n_epochs)


# python3 baseline_h36m.py --dataset_path '/home/caleml/datasets/h36m' --dataset_name 'h36m' --model_name '' --n_epochs 60 --batch_size 32 --pose_blocks 2 --gpu 3
